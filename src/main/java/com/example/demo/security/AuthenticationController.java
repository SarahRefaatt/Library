...
public class AuthenticationController {
	...
	public ResponseEntity<String> register(@RequestBody RegisterDto registerDto) {
		...
		//userDao.saveUser(registerDto.getName(),registerDto.getPassword());
...
//
//		return ResponseEntity.status(400).body("No Match for such a User please reenter your data correctly");
//
//	}
//
//
...
//		}
//
//		//User user = new User(registerDto.getName(), passwordEncoder.encode((registerDto.getPassword())), Collections.singleton(new SimpleGrantedAuthority("ROLE_USER")));
//		User user = new User();
//		user.setName(registerDto.getName());
//		user.setPassword(passwordEncoder.encode((registerDto.getPassword())));
//
